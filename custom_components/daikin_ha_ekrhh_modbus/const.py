...
ALTHERMA_4_INPUT = [
    ...
    [63,"Disinfaction state","Disinfaction state",None,None,],
    [64,"Holiday mode","Holiday mode",None,None,],
    [65,"Demand response mode","Demand response mode",None,None,],
    [66,"Bypass Valve Position","Bypass Valve Position",None,None,],
    [67,"Tank Valve Position","Tank Valve Position",None,None,],
    [68,"Circulation Pump Speed","Circulation Pump Speed",None,None,],
    [69,"Mixed Pump PWM in Mixing kit","Mixed Pump PWM in Mixing kit",None,None,],
...
ALTHERMA_4_HOLDING = [
    ...
    [3,"Operation Mode","Operation Mode",None,None,],
    [4,"Space Heating/Cooling On/Off","Space Heating/Cooling On/Off",None,None,],
